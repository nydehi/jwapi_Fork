...
function CM_Add_Empty_Log_Conf; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_Empty_Log_Conf';
function CM_Add_Empty_Log_Conf_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_Empty_Log_Conf_Ex';
function CM_Add_ID; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_ID' + NameSuffix;
function CM_Add_IDA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_IDA';
function CM_Add_IDW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_IDW';
function CM_Add_ID_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_ID_Ex' + NameSuffix;
function CM_Add_ID_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_ID_ExA';
function CM_Add_ID_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_ID_ExW';
function CM_Add_Range; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_Range';
function CM_Add_Res_Des; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_Res_Des';
function CM_Add_Res_Des_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Add_Res_Des_Ex';
function CM_Connect_Machine; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Connect_Machine' + NameSuffix;
function CM_Connect_MachineA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Connect_MachineA';
function CM_Connect_MachineW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Connect_MachineW';
function CM_Create_DevNode; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNode' + NameSuffix;
function CM_Create_DevNodeA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNodeA';
function CM_Create_DevNodeW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNodeW';
function CM_Create_DevNode_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNode_Ex' + NameSuffix;
function CM_Create_DevNode_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNode_ExA';
function CM_Create_DevNode_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNode_ExW';
function CM_Create_DevInst; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNode' + NameSuffix;
function CM_Create_DevInstA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNodeA';
function CM_Create_DevInstW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNodeW';
function CM_Create_DevInst_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNode_Ex' + NameSuffix;
function CM_Create_DevInst_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNode_ExA';
function CM_Create_DevInst_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_DevNode_ExW';
function CM_Create_Range_List; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Create_Range_List';
function CM_Delete_Class_Key; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Delete_Class_Key';
function CM_Delete_Class_Key_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Delete_Class_Key_Ex';
function CM_Delete_DevNode_Key; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Delete_DevNode_Key';
function CM_Delete_DevNode_Key_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Delete_DevNode_Key_Ex';
function CM_Delete_DevInst_Key; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Delete_DevNode_Key';
function CM_Delete_DevInst_Key_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Delete_DevNode_Key_Ex';
function CM_Delete_Range; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Delete_Range';
function CM_Detect_Resource_Conflict; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Detect_Resource_Conflict';
function CM_Detect_Resource_Conflict_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Detect_Resource_Conflict_Ex';
function CM_Disable_DevNode; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Disable_DevNode';
function CM_Disable_DevNode_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Disable_DevNode_Ex';
function CM_Disable_DevInst; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Disable_DevNode';
function CM_Disable_DevInst_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Disable_DevNode_Ex';
function CM_Disconnect_Machine; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Disconnect_Machine';
function CM_Dup_Range_List; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Dup_Range_List';
function CM_Enable_DevNode; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enable_DevNode';
function CM_Enable_DevNode_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enable_DevNode_Ex';
function CM_Enable_DevInst; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enable_DevNode';
function CM_Enable_DevInst_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enable_DevNode_Ex';
function CM_Enumerate_Classes; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enumerate_Classes';
function CM_Enumerate_Classes_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enumerate_Classes_Ex';
function CM_Enumerate_Enumerators; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enumerate_Enumerators' + NameSuffix;
function CM_Enumerate_EnumeratorsA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enumerate_EnumeratorsA';
function CM_Enumerate_EnumeratorsW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enumerate_EnumeratorsW';
function CM_Enumerate_Enumerators_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enumerate_Enumerators_Ex' + NameSuffix;
function CM_Enumerate_Enumerators_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enumerate_Enumerators_ExA';
function CM_Enumerate_Enumerators_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Enumerate_Enumerators_ExW';
function CM_Find_Range; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Find_Range';
function CM_First_Range; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_First_Range';
function CM_Free_Log_Conf; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Free_Log_Conf';
function CM_Free_Log_Conf_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Free_Log_Conf_Ex';
function CM_Free_Log_Conf_Handle; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Free_Log_Conf_Handle';
function CM_Free_Range_List; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Free_Range_List';
function CM_Free_Res_Des; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Free_Res_Des';
function CM_Free_Res_Des_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Free_Res_Des_Ex';
function CM_Free_Res_Des_Handle; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Free_Res_Des_Handle';
function CM_Get_Child; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Child';
function CM_Get_Child_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Child_Ex';
function CM_Get_Class_Name; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Name' + NameSuffix;
function CM_Get_Class_NameA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_NameA';
function CM_Get_Class_NameW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_NameW';
function CM_Get_Class_Name_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Name_Ex' + NameSuffix;
function CM_Get_Class_Name_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Name_ExA';
function CM_Get_Class_Name_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Name_ExW';
function CM_Get_Class_Key_Name; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Key_Name' + NameSuffix;
function CM_Get_Class_Key_NameA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Key_NameA';
function CM_Get_Class_Key_NameW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Key_NameW';
function CM_Get_Class_Key_Name_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Key_Name_Ex' + NameSuffix;
function CM_Get_Class_Key_Name_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Key_Name_ExA';
function CM_Get_Class_Key_Name_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Key_Name_ExW';
function CM_Get_Depth; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Depth';
function CM_Get_Depth_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Depth_Ex';
function CM_Get_Device_ID; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID' + NameSuffix;
function CM_Get_Device_IDA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_IDA';
function CM_Get_Device_IDW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_IDW';
function CM_Get_Device_ID_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_Ex' + NameSuffix;
function CM_Get_Device_ID_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_ExA';
function CM_Get_Device_ID_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_ExW';
function CM_Get_Device_ID_List; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List' + NameSuffix;
function CM_Get_Device_ID_ListA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_ListA';
function CM_Get_Device_ID_ListW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_ListW';
function CM_Get_Device_ID_List_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List_Ex' + NameSuffix;
function CM_Get_Device_ID_List_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List_ExA';
function CM_Get_Device_ID_List_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List_ExW';
function CM_Get_Device_ID_List_Size; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List_Size' + NameSuffix;
function CM_Get_Device_ID_List_SizeA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List_SizeA';
function CM_Get_Device_ID_List_SizeW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List_SizeW';
function CM_Get_Device_ID_List_Size_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List_Size_Ex' + NameSuffix;
function CM_Get_Device_ID_List_Size_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List_Size_ExA';
function CM_Get_Device_ID_List_Size_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_List_Size_ExW';
function CM_Get_Device_ID_Size; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_Size';
function CM_Get_Device_ID_Size_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_ID_Size_Ex';
function CM_Get_DevNode_Registry_Property; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_Property' + NameSuffix;
function CM_Get_DevNode_Registry_PropertyA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_PropertyA';
function CM_Get_DevNode_Registry_PropertyW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_PropertyW';
function CM_Get_DevNode_Registry_Property_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_Property_Ex' + NameSuffix;
function CM_Get_DevNode_Registry_Property_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_Property_ExA';
function CM_Get_DevNode_Registry_Property_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_Property_ExW';
function CM_Get_DevInst_Registry_Property; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_Property' + NameSuffix;
function CM_Get_DevInst_Registry_PropertyA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_PropertyA';
function CM_Get_DevInst_Registry_PropertyW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_PropertyW';
function CM_Get_DevInst_Registry_Property_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_Property_Ex' + NameSuffix;
function CM_Get_DevInst_Registry_Property_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_Property_ExA';
function CM_Get_DevInst_Registry_Property_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Registry_Property_ExW';
{$IFDEF WINXP_UP}
function CM_Get_DevNode_Custom_Property; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_Property' + NameSuffix;
function CM_Get_DevNode_Custom_PropertyA; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_PropertyA';
function CM_Get_DevNode_Custom_PropertyW; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_PropertyW';
function CM_Get_DevNode_Custom_Property_Ex; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_Property_Ex' + NameSuffix;
function CM_Get_DevNode_Custom_Property_ExA; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_Property_ExA';
function CM_Get_DevNode_Custom_Property_ExW; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_Property_ExW';
function CM_Get_DevInst_Custom_Property; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_Property' + NameSuffix;
function CM_Get_DevInst_Custom_PropertyA; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_PropertyA';
function CM_Get_DevInst_Custom_PropertyW; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_PropertyW';
function CM_Get_DevInst_Custom_Property_Ex; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_Property_Ex' + NameSuffix;
function CM_Get_DevInst_Custom_Property_ExA; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_Property_ExA';
function CM_Get_DevInst_Custom_Property_ExW; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Custom_Property_ExW';
{$ENDIF WINXP_UP}
function CM_Get_DevNode_Status; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Status';
function CM_Get_DevInst_Status; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Status';
function CM_Get_DevNode_Status_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Status_Ex';
function CM_Get_DevInst_Status_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_DevNode_Status_Ex';
function CM_Get_First_Log_Conf; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_First_Log_Conf';
function CM_Get_First_Log_Conf_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_First_Log_Conf_Ex';
function CM_Get_Global_State; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Global_State';
function CM_Get_Global_State_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Global_State_Ex';
function CM_Get_Hardware_Profile_Info; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Hardware_Profile_Info' + NameSuffix;
function CM_Get_Hardware_Profile_InfoA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Hardware_Profile_InfoA';
function CM_Get_Hardware_Profile_Info_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Hardware_Profile_Info_Ex' + NameSuffix;
function CM_Get_Hardware_Profile_Info_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Hardware_Profile_Info_ExA';
function CM_Get_Hardware_Profile_InfoW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Hardware_Profile_InfoW';
function CM_Get_Hardware_Profile_Info_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Hardware_Profile_Info_ExW';
function CM_Get_HW_Prof_Flags; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_HW_Prof_Flags' + NameSuffix;
function CM_Get_HW_Prof_FlagsA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_HW_Prof_FlagsA';
function CM_Get_HW_Prof_FlagsW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_HW_Prof_FlagsW';
function CM_Get_HW_Prof_Flags_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_HW_Prof_Flags_Ex' + NameSuffix;
function CM_Get_HW_Prof_Flags_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_HW_Prof_Flags_ExA';
function CM_Get_HW_Prof_Flags_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_HW_Prof_Flags_ExW';
{$IFNDEF WINNT4}
function CM_Get_Device_Interface_Alias; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_Alias' + NameSuffix;
function CM_Get_Device_Interface_AliasA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_AliasA';
function CM_Get_Device_Interface_AliasW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_AliasW';
function CM_Get_Device_Interface_Alias_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_Alias_Ex' + NameSuffix;
function CM_Get_Device_Interface_Alias_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_Alias_ExA';
function CM_Get_Device_Interface_Alias_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_Alias_ExW';
function CM_Get_Device_Interface_List; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List' + NameSuffix;
function CM_Get_Device_Interface_ListA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_ListA';
function CM_Get_Device_Interface_ListW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_ListW';
function CM_Get_Device_Interface_List_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List_Ex' + NameSuffix;
function CM_Get_Device_Interface_List_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List_ExA';
function CM_Get_Device_Interface_List_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List_ExW';
function CM_Get_Device_Interface_List_Size; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List_Size' + NameSuffix;
function CM_Get_Device_Interface_List_SizeA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List_SizeA';
function CM_Get_Device_Interface_List_SizeW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List_SizeW';
function CM_Get_Device_Interface_List_Size_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List_Size_Ex' + NameSuffix;
function CM_Get_Device_Interface_List_Size_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List_Size_ExA';
function CM_Get_Device_Interface_List_Size_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Device_Interface_List_Size_ExW';
function CM_Get_Log_Conf_Priority; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Log_Conf_Priority';
function CM_Get_Log_Conf_Priority_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Log_Conf_Priority_Ex';
{$ENDIF !WINNT4}
function CM_Get_Next_Log_Conf; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Next_Log_Conf';
function CM_Get_Next_Log_Conf_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Next_Log_Conf_Ex';
function CM_Get_Parent; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Parent';
function CM_Get_Parent_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Parent_Ex';
function CM_Get_Res_Des_Data; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Res_Des_Data';
function CM_Get_Res_Des_Data_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Res_Des_Data_Ex';
function CM_Get_Res_Des_Data_Size; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Res_Des_Data_Size';
function CM_Get_Res_Des_Data_Size_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Res_Des_Data_Size_Ex';
function CM_Get_Sibling; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Sibling';
function CM_Get_Sibling_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Sibling_Ex';
function CM_Get_Version; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Version';
function CM_Get_Version_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Version_Ex';
{$IFDEF WINXP_UP}
//function CM_Is_Version_Available; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Is_Version_Available';
//function CM_Is_Version_Available_Ex; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Is_Version_Available_Ex';
{$ENDIF WINXP_UP}
function CM_Intersect_Range_List; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Intersect_Range_List';
function CM_Invert_Range_List; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Invert_Range_List';
function CM_Locate_DevNode; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNode' + NameSuffix;
function CM_Locate_DevNodeA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNodeA';
function CM_Locate_DevNodeW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNodeW';
function CM_Locate_DevNode_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNode_Ex' + NameSuffix;
function CM_Locate_DevNode_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNode_ExA';
function CM_Locate_DevNode_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNode_ExW';
function CM_Locate_DevInst; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNode' + NameSuffix;
function CM_Locate_DevInstA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNodeA';
function CM_Locate_DevInstW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNodeW';
function CM_Locate_DevInst_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNode_Ex' + NameSuffix;
function CM_Locate_DevInst_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNode_ExA';
function CM_Locate_DevInst_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Locate_DevNode_ExW';
function CM_Merge_Range_List; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Merge_Range_List';
function CM_Modify_Res_Des; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Modify_Res_Des';
function CM_Modify_Res_Des_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Modify_Res_Des_Ex';
function CM_Move_DevNode; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Move_DevNode';
function CM_Move_DevInst; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Move_DevNode';
function CM_Move_DevNode_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Move_DevNode_Ex';
function CM_Move_DevInst_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Move_DevNode_Ex';
function CM_Next_Range; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Next_Range';
function CM_Get_Next_Res_Des; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Next_Res_Des';
function CM_Get_Next_Res_Des_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Next_Res_Des_Ex';
function CM_Open_Class_Key; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_Class_Key' + NameSuffix;
function CM_Open_Class_KeyA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_Class_KeyA';
function CM_Open_Class_KeyW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_Class_KeyW';
function CM_Open_Class_Key_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_Class_Key_Ex' + NameSuffix;
function CM_Open_Class_Key_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_Class_Key_ExA';
function CM_Open_Class_Key_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_Class_Key_ExW';
function CM_Open_DevNode_Key; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_DevNode_Key';
function CM_Open_DevInst_Key; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_DevNode_Key';
function CM_Open_DevNode_Key_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_DevNode_Key_Ex';
function CM_Open_DevInst_Key_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Open_DevNode_Key_Ex';
function CM_Query_Arbitrator_Free_Data; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_Arbitrator_Free_Data';
function CM_Query_Arbitrator_Free_Data_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_Arbitrator_Free_Data_Ex';
function CM_Query_Arbitrator_Free_Size; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_Arbitrator_Free_Size';
function CM_Query_Arbitrator_Free_Size_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_Arbitrator_Free_Size_Ex';
function CM_Query_Remove_SubTree; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_Remove_SubTree';
function CM_Query_Remove_SubTree_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_Remove_SubTree_Ex';
{$IFDEF WIN2000_UP}
function CM_Query_And_Remove_SubTree; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_And_Remove_SubTree' + NameSuffix;
function CM_Query_And_Remove_SubTreeA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_And_Remove_SubTreeA';
function CM_Query_And_Remove_SubTree_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_And_Remove_SubTree_Ex' + NameSuffix;
function CM_Query_And_Remove_SubTree_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_And_Remove_SubTree_ExA';
function CM_Query_And_Remove_SubTreeW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_And_Remove_SubTreeW';
function CM_Query_And_Remove_SubTree_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_And_Remove_SubTree_ExW';
function CM_Request_Device_Eject; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Request_Device_Eject' + NameSuffix;
function CM_Request_Device_EjectA; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Request_Device_EjectA';
function CM_Request_Device_EjectW; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Request_Device_EjectW';
function CM_Request_Device_Eject_Ex; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Request_Device_Eject_Ex' + NameSuffix;
function CM_Request_Device_Eject_ExA; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Request_Device_Eject_ExA';
function CM_Request_Device_Eject_ExW; external SetupApiDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Request_Device_Eject_ExW';
{$ENDIF WIN2000_UP}
function CM_Reenumerate_DevNode; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Reenumerate_DevNode';
function CM_Reenumerate_DevInst; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Reenumerate_DevNode';
function CM_Reenumerate_DevNode_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Reenumerate_DevNode_Ex';
function CM_Reenumerate_DevInst_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Reenumerate_DevNode_Ex';
{$IFNDEF WINNT4}
function CM_Register_Device_Interface; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Register_Device_Interface' + NameSuffix;
function CM_Register_Device_InterfaceA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Register_Device_InterfaceA';
function CM_Register_Device_InterfaceW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Register_Device_InterfaceW';
function CM_Register_Device_Interface_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Register_Device_Interface_Ex' + NameSuffix;
function CM_Register_Device_Interface_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Register_Device_Interface_ExA';
function CM_Register_Device_Interface_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Register_Device_Interface_ExW';
function CM_Set_DevNode_Problem_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Problem_Ex';
function CM_Set_DevInst_Problem_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Problem_Ex';
function CM_Set_DevNode_Problem; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Problem';
function CM_Set_DevInst_Problem; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Problem';
function CM_Unregister_Device_Interface; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Unregister_Device_Interface' + NameSuffix;
function CM_Unregister_Device_InterfaceA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Unregister_Device_InterfaceA';
function CM_Unregister_Device_InterfaceW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Unregister_Device_InterfaceW';
function CM_Unregister_Device_Interface_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Unregister_Device_Interface_Ex' + NameSuffix;
function CM_Unregister_Device_Interface_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Unregister_Device_Interface_ExA';
function CM_Unregister_Device_Interface_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Unregister_Device_Interface_ExW';
function CM_Register_Device_Driver; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Register_Device_Driver';
function CM_Register_Device_Driver_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Register_Device_Driver_Ex';
{$ENDIF !WINNT4}
function CM_Remove_SubTree; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Remove_SubTree';
function CM_Remove_SubTree_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Remove_SubTree_Ex';
function CM_Set_DevNode_Registry_Property; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_Property' + NameSuffix;
function CM_Set_DevNode_Registry_PropertyA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_PropertyA';
function CM_Set_DevNode_Registry_PropertyW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_PropertyW';
function CM_Set_DevNode_Registry_Property_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_Property_Ex' + NameSuffix;
function CM_Set_DevNode_Registry_Property_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_Property_ExA';
function CM_Set_DevNode_Registry_Property_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_Property_ExW';
function CM_Set_DevInst_Registry_Property; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_Property' + NameSuffix;
function CM_Set_DevInst_Registry_PropertyA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_PropertyA';
function CM_Set_DevInst_Registry_PropertyW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_PropertyW';
function CM_Set_DevInst_Registry_Property_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_Property_Ex' + NameSuffix;
function CM_Set_DevInst_Registry_Property_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_Property_ExA';
function CM_Set_DevInst_Registry_Property_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_DevNode_Registry_Property_ExW';
{$IFNDEF WINNT4}
function CM_Is_Dock_Station_Present; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Is_Dock_Station_Present';
{$ENDIF !WINNT4}
{$IFDEF WIN2000_UP}
function CM_Is_Dock_Station_Present_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Is_Dock_Station_Present_Ex';
{$ENDIF WIN2000_UP}
{$IFNDEF WINNT4}
function CM_Request_Eject_PC; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Request_Eject_PC';
{$ENDIF !WINNT4}
{$IFDEF WIN2000_UP}
function CM_Request_Eject_PC_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Request_Eject_PC_Ex';
{$ENDIF WIN2000_UP}
function CM_Set_HW_Prof_Flags; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_HW_Prof_Flags' + NameSuffix;
function CM_Set_HW_Prof_FlagsA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_HW_Prof_FlagsA';
function CM_Set_HW_Prof_FlagsW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_HW_Prof_FlagsW';
function CM_Set_HW_Prof_Flags_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_HW_Prof_Flags_Ex' + NameSuffix;
function CM_Set_HW_Prof_Flags_ExA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_HW_Prof_Flags_ExA';
function CM_Set_HW_Prof_Flags_ExW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_HW_Prof_Flags_ExW';
function CM_Setup_DevNode; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Setup_DevNode';
function CM_Setup_DevInst; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Setup_DevNode';
function CM_Setup_DevNode_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Setup_DevNode_Ex';
function CM_Setup_DevInst_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Setup_DevNode_Ex';
function CM_Test_Range_Available; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Test_Range_Available';
function CM_Uninstall_DevNode; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Uninstall_DevNode';
function CM_Uninstall_DevInst; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Uninstall_DevNode';
function CM_Uninstall_DevNode_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Uninstall_DevNode_Ex';
function CM_Uninstall_DevInst_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Uninstall_DevNode_Ex';
function CM_Run_Detection; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Run_Detection';
function CM_Run_Detection_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Run_Detection_Ex';
function CM_Set_HW_Prof; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_HW_Prof';
function CM_Set_HW_Prof_Ex; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_HW_Prof_Ex';
{$IFDEF WIN2000_UP}
function CM_Query_Resource_Conflict_List; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Query_Resource_Conflict_List';
function CM_Free_Resource_Conflict_Handle; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Free_Resource_Conflict_Handle';
function CM_Get_Resource_Conflict_Count; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Resource_Conflict_Count';
function CM_Get_Resource_Conflict_Details; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Resource_Conflict_Details' + NameSuffix;
function CM_Get_Resource_Conflict_DetailsA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Resource_Conflict_DetailsA';
function CM_Get_Resource_Conflict_DetailsW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Resource_Conflict_DetailsW';
function CM_Get_Class_Registry_Property; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Registry_Property' + NameSuffix;
function CM_Get_Class_Registry_PropertyA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Registry_PropertyA';
function CM_Get_Class_Registry_PropertyW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Get_Class_Registry_PropertyW';
function CM_Set_Class_Registry_Property; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_Class_Registry_Property' + NameSuffix;
function CM_Set_Class_Registry_PropertyA; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_Class_Registry_PropertyA';
function CM_Set_Class_Registry_PropertyW; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CM_Set_Class_Registry_PropertyW';
function CM_WaitNoPendingInstallEvents; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CMP_WaitNoPendingInstallEvents';
function CMP_WaitNoPendingInstallEvents; external CfgMgrDllName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'CMP_WaitNoPendingInstallEvents';
{$ENDIF WIN2000_UP}
