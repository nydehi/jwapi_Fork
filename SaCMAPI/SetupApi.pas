...
{$IFDEF WINXP_UP}
function SetupGetFileQueueCount; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetFileQueueCount';
function SetupGetFileQueueFlags; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetFileQueueFlags';
function SetupSetFileQueueFlags; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetFileQueueFlags';
{$ENDIF WINXP_UP}
function SetupGetInfInformationA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetInfInformationA';
function SetupGetInfInformationW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetInfInformationW';
function SetupGetInfInformation; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetInfInformation' + NameSuffix;
function SetupQueryInfFileInformationA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryInfFileInformationA';
function SetupQueryInfFileInformationW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryInfFileInformationW';
function SetupQueryInfFileInformation; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryInfFileInformation' + NameSuffix;
{$IFDEF WIN2000_UP}
function SetupQueryInfOriginalFileInformationA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryInfOriginalFileInformationA';
function SetupQueryInfOriginalFileInformationW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryInfOriginalFileInformationW';
function SetupQueryInfOriginalFileInformation; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryInfOriginalFileInformation' + NameSuffix;
{$ENDIF WIN2000_UP}
function SetupQueryInfVersionInformationA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryInfVersionInformationA';
function SetupQueryInfVersionInformationW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryInfVersionInformationW';
function SetupQueryInfVersionInformation; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryInfVersionInformation' + NameSuffix;
function SetupGetInfFileListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetInfFileListA';
function SetupGetInfFileListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetInfFileListW';
function SetupGetInfFileList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetInfFileList' + NameSuffix;
function SetupOpenInfFileA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupOpenInfFileA';
function SetupOpenInfFileW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupOpenInfFileW';
function SetupOpenInfFile; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupOpenInfFile' + NameSuffix;
function SetupOpenMasterInf; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupOpenMasterInf';
function SetupOpenAppendInfFileA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupOpenAppendInfFileA';
function SetupOpenAppendInfFileW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupOpenAppendInfFileW';
function SetupOpenAppendInfFile; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupOpenAppendInfFile' + NameSuffix;
procedure SetupCloseInfFile; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCloseInfFile';
function SetupFindFirstLineA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFindFirstLineA';
function SetupFindFirstLineW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFindFirstLineW';
function SetupFindFirstLine; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFindFirstLine' + NameSuffix;
function SetupFindNextLine; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFindNextLine';
function SetupFindNextMatchLineA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFindNextMatchLineA';
function SetupFindNextMatchLineW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFindNextMatchLineW';
function SetupFindNextMatchLine; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFindNextMatchLine' + NameSuffix;
function SetupGetLineByIndexA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetLineByIndexA';
function SetupGetLineByIndexW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetLineByIndexW';
function SetupGetLineByIndex; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetLineByIndex' + NameSuffix;
function SetupGetLineCountA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetLineCountA';
function SetupGetLineCountW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetLineCountW';
function SetupGetLineCount; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetLineCount' + NameSuffix;
function SetupGetLineTextA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetLineTextA';
function SetupGetLineTextW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetLineTextW';
function SetupGetLineText; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetLineText' + NameSuffix;
function SetupGetFieldCount; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetFieldCount';
function SetupGetStringFieldA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetStringFieldA';
function SetupGetStringFieldW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetStringFieldW';
function SetupGetStringField; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetStringField' + NameSuffix;
function SetupGetIntField; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetIntField';
function SetupGetMultiSzFieldA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetMultiSzFieldA';
function SetupGetMultiSzFieldW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetMultiSzFieldW';
function SetupGetMultiSzField; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetMultiSzField' + NameSuffix;
function SetupGetBinaryField; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetBinaryField';
function SetupGetFileCompressionInfoA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetFileCompressionInfoA';
function SetupGetFileCompressionInfoW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetFileCompressionInfoW';
function SetupGetFileCompressionInfo; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetFileCompressionInfo' + NameSuffix;
{$IFDEF WINXP_UP}
function SetupGetFileCompressionInfoExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetFileCompressionInfoExA';
function SetupGetFileCompressionInfoExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetFileCompressionInfoExW';
function SetupGetFileCompressionInfoEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetFileCompressionInfoEx' + NameSuffix;
{$ENDIF WINXP_UP}
function SetupDecompressOrCopyFileA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDecompressOrCopyFileA';
function SetupDecompressOrCopyFileW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDecompressOrCopyFileW';
function SetupDecompressOrCopyFile; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDecompressOrCopyFile' + NameSuffix;
function SetupGetSourceFileLocationA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetSourceFileLocationA';
function SetupGetSourceFileLocationW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetSourceFileLocationW';
function SetupGetSourceFileLocation; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetSourceFileLocation' + NameSuffix;
function SetupGetSourceFileSizeA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetSourceFileSizeA';
function SetupGetSourceFileSizeW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetSourceFileSizeW';
function SetupGetSourceFileSize; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetSourceFileSize' + NameSuffix;
function SetupGetTargetPathA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetTargetPathA';
function SetupGetTargetPathW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetTargetPathW';
function SetupGetTargetPath; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetTargetPath' + NameSuffix;
function SetupSetSourceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetSourceListA';
function SetupSetSourceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetSourceListW';
function SetupSetSourceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetSourceList' + NameSuffix;
function SetupCancelTemporarySourceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCancelTemporarySourceList';
function SetupAddToSourceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddToSourceListA';
function SetupAddToSourceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddToSourceListW';
function SetupAddToSourceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddToSourceList' + NameSuffix;
function SetupRemoveFromSourceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveFromSourceListA';
function SetupRemoveFromSourceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveFromSourceListW';
function SetupRemoveFromSourceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveFromSourceList' + NameSuffix;
function SetupQuerySourceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQuerySourceListA';
function SetupQuerySourceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQuerySourceListW';
function SetupQuerySourceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQuerySourceList' + NameSuffix;
function SetupFreeSourceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFreeSourceListA';
function SetupFreeSourceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFreeSourceListW';
function SetupFreeSourceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupFreeSourceList' + NameSuffix;
function SetupPromptForDiskA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupPromptForDiskA';
function SetupPromptForDiskW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupPromptForDiskW';
function SetupPromptForDisk; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupPromptForDisk' + NameSuffix;
function SetupCopyErrorA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCopyErrorA';
function SetupCopyErrorW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCopyErrorW';
function SetupCopyError; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCopyError' + NameSuffix;
function SetupRenameErrorA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRenameErrorA';
function SetupRenameErrorW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRenameErrorW';
function SetupRenameError; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRenameError' + NameSuffix;
function SetupDeleteErrorA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDeleteErrorA';
function SetupDeleteErrorW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDeleteErrorW';
function SetupDeleteError; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDeleteError' + NameSuffix;
{$IFDEF WIN2000_UP}
function SetupBackupErrorA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupBackupErrorA';
function SetupBackupErrorW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupBackupErrorW';
function SetupBackupError; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupBackupError' + NameSuffix;
{$ENDIF WIN2000_UP}
function SetupSetDirectoryIdA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetDirectoryIdA';
function SetupSetDirectoryIdW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetDirectoryIdW';
function SetupSetDirectoryId; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetDirectoryId' + NameSuffix;
function SetupSetDirectoryIdExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetDirectoryIdExA';
function SetupSetDirectoryIdExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetDirectoryIdExW';
function SetupSetDirectoryIdEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetDirectoryIdEx' + NameSuffix;
function SetupGetSourceInfoA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetSourceInfoA';
function SetupGetSourceInfoW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetSourceInfoW';
function SetupGetSourceInfo; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetSourceInfo' + NameSuffix;
function SetupInstallFileA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFileA';
function SetupInstallFileW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFileW';
function SetupInstallFile; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFile' + NameSuffix;
function SetupInstallFileExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFileExA';
function SetupInstallFileExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFileExW';
function SetupInstallFileEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFileEx' + NameSuffix;
function SetupOpenFileQueue; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupOpenFileQueue';
function SetupCloseFileQueue; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCloseFileQueue';
{$IFDEF WIN2000_UP}
function SetupSetFileQueueAlternatePlatformA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetFileQueueAlternatePlatformA';
function SetupSetFileQueueAlternatePlatformW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetFileQueueAlternatePlatformW';
function SetupSetFileQueueAlternatePlatform; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetFileQueueAlternatePlatform' + NameSuffix;
{$ENDIF WIN2000_UP}
function SetupSetPlatformPathOverrideA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetPlatformPathOverrideA';
function SetupSetPlatformPathOverrideW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetPlatformPathOverrideW';
function SetupSetPlatformPathOverride; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetPlatformPathOverride' + NameSuffix;
function SetupQueueCopyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueCopyA';
function SetupQueueCopyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueCopyW';
function SetupQueueCopy; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueCopy' + NameSuffix;
{$IFDEF WIN2000_UP}
function SetupQueueCopyIndirectA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueCopyIndirectA';
function SetupQueueCopyIndirectW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueCopyIndirectW';
function SetupQueueCopyIndirect; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueCopyIndirect' + NameSuffix;
{$ENDIF WIN2000_UP}
function SetupQueueDefaultCopyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueDefaultCopyA';
function SetupQueueDefaultCopyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueDefaultCopyW';
function SetupQueueDefaultCopy; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueDefaultCopy' + NameSuffix;
function SetupQueueCopySectionA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueCopySectionA';
function SetupQueueCopySectionW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueCopySectionW';
function SetupQueueCopySection; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueCopySection' + NameSuffix;
function SetupQueueDeleteA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueDeleteA';
function SetupQueueDeleteW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueDeleteW';
function SetupQueueDelete; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueDelete' + NameSuffix;
function SetupQueueDeleteSectionA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueDeleteSectionA';
function SetupQueueDeleteSectionW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueDeleteSectionW';
function SetupQueueDeleteSection; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueDeleteSection' + NameSuffix;
function SetupQueueRenameA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueRenameA';
function SetupQueueRenameW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueRenameW';
function SetupQueueRename; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueRename' + NameSuffix;
function SetupQueueRenameSectionA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueRenameSectionA';
function SetupQueueRenameSectionW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueRenameSectionW';
function SetupQueueRenameSection; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueueRenameSection' + NameSuffix;
function SetupCommitFileQueueA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCommitFileQueueA';
function SetupCommitFileQueueW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCommitFileQueueW';
function SetupCommitFileQueue; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCommitFileQueue' + NameSuffix;
function SetupScanFileQueueA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupScanFileQueueA';
function SetupScanFileQueueW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupScanFileQueueW';
function SetupScanFileQueue; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupScanFileQueue' + NameSuffix;
function SetupCopyOEMInfA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCopyOEMInfA';
function SetupCopyOEMInfW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCopyOEMInfW';
function SetupCopyOEMInf; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCopyOEMInf' + NameSuffix;
{$IFDEF WINXP_UP}
function SetupUninstallOEMInfA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupUninstallOEMInfA';
function SetupUninstallOEMInfW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupUninstallOEMInfW';
function SetupUninstallOEMInf; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupUninstallOEMInf' + NameSuffix;
function SetupUninstallNewlyCopiedInfs; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupUninstallNewlyCopiedInfs';
{$ENDIF WINXP_UP}
function SetupCreateDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCreateDiskSpaceListA';
function SetupCreateDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCreateDiskSpaceListW';
function SetupCreateDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCreateDiskSpaceList' + NameSuffix;
function SetupDuplicateDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDuplicateDiskSpaceListA';
function SetupDuplicateDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDuplicateDiskSpaceListW';
function SetupDuplicateDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDuplicateDiskSpaceList' + NameSuffix;
function SetupDestroyDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDestroyDiskSpaceList';
function SetupQueryDrivesInDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryDrivesInDiskSpaceListA';
function SetupQueryDrivesInDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryDrivesInDiskSpaceListW';
function SetupQueryDrivesInDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryDrivesInDiskSpaceList' + NameSuffix;
function SetupQuerySpaceRequiredOnDriveA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQuerySpaceRequiredOnDriveA';
function SetupQuerySpaceRequiredOnDriveW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQuerySpaceRequiredOnDriveW';
function SetupQuerySpaceRequiredOnDrive; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQuerySpaceRequiredOnDrive' + NameSuffix;
function SetupAdjustDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAdjustDiskSpaceListA';
function SetupAdjustDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAdjustDiskSpaceListW';
function SetupAdjustDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAdjustDiskSpaceList' + NameSuffix;
function SetupAddToDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddToDiskSpaceListA';
function SetupAddToDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddToDiskSpaceListW';
function SetupAddToDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddToDiskSpaceList' + NameSuffix;
function SetupAddSectionToDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddSectionToDiskSpaceListA';
function SetupAddSectionToDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddSectionToDiskSpaceListW';
function SetupAddSectionToDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddSectionToDiskSpaceList' + NameSuffix;
function SetupAddInstallSectionToDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddInstallSectionToDiskSpaceListA';
function SetupAddInstallSectionToDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddInstallSectionToDiskSpaceListW';
function SetupAddInstallSectionToDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupAddInstallSectionToDiskSpaceList' + NameSuffix;
function SetupRemoveFromDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveFromDiskSpaceListA';
function SetupRemoveFromDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveFromDiskSpaceListW';
function SetupRemoveFromDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveFromDiskSpaceList' + NameSuffix;
function SetupRemoveSectionFromDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveSectionFromDiskSpaceListA';
function SetupRemoveSectionFromDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveSectionFromDiskSpaceListW';
function SetupRemoveSectionFromDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveSectionFromDiskSpaceList' + NameSuffix;
function SetupRemoveInstallSectionFromDiskSpaceListA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveInstallSectionFromDiskSpaceListA';
function SetupRemoveInstallSectionFromDiskSpaceListW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveInstallSectionFromDiskSpaceListW';
function SetupRemoveInstallSectionFromDiskSpaceList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveInstallSectionFromDiskSpaceList' + NameSuffix;
function SetupIterateCabinetA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupIterateCabinetA';
function SetupIterateCabinetW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupIterateCabinetW';
function SetupIterateCabinet; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupIterateCabinet' + NameSuffix;
function SetupPromptReboot; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupPromptReboot';
function SetupInitDefaultQueueCallback; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInitDefaultQueueCallback';
function SetupInitDefaultQueueCallbackEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInitDefaultQueueCallbackEx';
procedure SetupTermDefaultQueueCallback; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupTermDefaultQueueCallback';
function SetupDefaultQueueCallbackA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDefaultQueueCallbackA';
function SetupDefaultQueueCallbackW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDefaultQueueCallbackW';
function SetupDefaultQueueCallback; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDefaultQueueCallback' + NameSuffix;
function SetupInstallFromInfSectionA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFromInfSectionA';
function SetupInstallFromInfSectionW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFromInfSectionW';
function SetupInstallFromInfSection; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFromInfSection' + NameSuffix;
function SetupInstallFilesFromInfSectionA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFilesFromInfSectionA';
function SetupInstallFilesFromInfSectionW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFilesFromInfSectionW';
function SetupInstallFilesFromInfSection; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallFilesFromInfSection' + NameSuffix;
function SetupInstallServicesFromInfSectionA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallServicesFromInfSectionA';
function SetupInstallServicesFromInfSectionW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallServicesFromInfSectionW';
function SetupInstallServicesFromInfSection; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallServicesFromInfSection' + NameSuffix;
function SetupInstallServicesFromInfSectionExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallServicesFromInfSectionExA';
function SetupInstallServicesFromInfSectionExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallServicesFromInfSectionExW';
function SetupInstallServicesFromInfSectionEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInstallServicesFromInfSectionEx' + NameSuffix;
{$IFDEF WINXP_UP}
procedure InstallHinfSectionA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InstallHinfSectionA';
procedure InstallHinfSectionW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InstallHinfSectionW';
procedure InstallHinfSection; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'InstallHinfSection' + NameSuffix;
{$ENDIF WINXP_UP}
function SetupInitializeFileLogA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInitializeFileLogA';
function SetupInitializeFileLogW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInitializeFileLogW';
function SetupInitializeFileLog; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupInitializeFileLog' + NameSuffix;
function SetupTerminateFileLog; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupTerminateFileLog';
function SetupLogFileA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupLogFileA';
function SetupLogFileW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupLogFileW';
function SetupLogFile; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupLogFile' + NameSuffix;
function SetupRemoveFileLogEntryA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveFileLogEntryA';
function SetupRemoveFileLogEntryW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveFileLogEntryW';
function SetupRemoveFileLogEntry; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupRemoveFileLogEntry' + NameSuffix;
function SetupQueryFileLogA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryFileLogA';
function SetupQueryFileLogW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryFileLogW';
function SetupQueryFileLog; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupQueryFileLog' + NameSuffix;
function SetupOpenLog; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupOpenLog';
function SetupLogErrorA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupLogErrorA';
function SetupLogErrorW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupLogErrorW';
function SetupLogError; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupLogError' + NameSuffix;
procedure SetupCloseLog; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupCloseLog';
{$IFDEF WIN2000_UP}
function SetupGetBackupInformationA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetBackupInformationA';
function SetupGetBackupInformationW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetBackupInformationW';
function SetupGetBackupInformation; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetBackupInformation' + NameSuffix;
{$ENDIF WIN2000_UP}
{$IFDEF WINXP_UP}
function SetupPrepareQueueForRestoreA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupPrepareQueueForRestoreA';
function SetupPrepareQueueForRestoreW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupPrepareQueueForRestoreW';
function SetupPrepareQueueForRestore; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupPrepareQueueForRestore' + NameSuffix;
function SetupSetNonInteractiveMode; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupSetNonInteractiveMode';
function SetupGetNonInteractiveMode; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupGetNonInteractiveMode';
{$ENDIF WINXP_UP}
function SetupDiCreateDeviceInfoList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInfoList';
function SetupDiCreateDeviceInfoListExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInfoListExA';
function SetupDiCreateDeviceInfoListExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInfoListExW';
function SetupDiCreateDeviceInfoListEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInfoListEx' + NameSuffix;
function SetupDiGetDeviceInfoListClass; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInfoListClass';
function SetupDiGetDeviceInfoListDetailA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInfoListDetailA';
function SetupDiGetDeviceInfoListDetailW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInfoListDetailW';
function SetupDiGetDeviceInfoListDetail; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInfoListDetail' + NameSuffix;
function SetupDiCreateDeviceInfoA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInfoA';
function SetupDiCreateDeviceInfoW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInfoW';
function SetupDiCreateDeviceInfo; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInfo' + NameSuffix;
function SetupDiOpenDeviceInfoA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInfoA';
function SetupDiOpenDeviceInfoW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInfoW';
function SetupDiOpenDeviceInfo; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInfo' + NameSuffix;
function SetupDiGetDeviceInstanceIdA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInstanceIdA';
function SetupDiGetDeviceInstanceIdW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInstanceIdW';
function SetupDiGetDeviceInstanceId; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInstanceId' + NameSuffix;
function SetupDiDeleteDeviceInfo; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDeleteDeviceInfo';
function SetupDiEnumDeviceInfo; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiEnumDeviceInfo';
function SetupDiDestroyDeviceInfoList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDestroyDeviceInfoList';
function SetupDiEnumDeviceInterfaces; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiEnumDeviceInterfaces';
function SetupDiEnumInterfaceDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiEnumDeviceInterfaces';
function SetupDiCreateDeviceInterfaceA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceA';
function SetupDiCreateInterfaceDeviceA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceA';
function SetupDiCreateDeviceInterfaceW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceW';
function SetupDiCreateInterfaceDeviceW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceW';
function SetupDiCreateDeviceInterface; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterface' + NameSuffix;
function SetupDiCreateInterfaceDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterface' + NameSuffix;
function SetupDiOpenDeviceInterfaceA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInterfaceA';
function SetupDiOpenInterfaceDeviceA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInterfaceA';
function SetupDiOpenDeviceInterfaceW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInterfaceW';
function SetupDiOpenInterfaceDeviceW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInterfaceW';
function SetupDiOpenDeviceInterface; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInterface' + NameSuffix;
function SetupDiOpenInterfaceDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInterface' + NameSuffix;
function SetupDiGetDeviceInterfaceAlias; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInterfaceAlias';
function SetupDiGetInterfaceDeviceAlias; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInterfaceAlias';
function SetupDiDeleteDeviceInterfaceData; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDeleteDeviceInterfaceData';
function SetupDiDeleteInterfaceDeviceData; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDeleteDeviceInterfaceData';
function SetupDiRemoveDeviceInterface; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiRemoveDeviceInterface';
function SetupDiRemoveInterfaceDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiRemoveDeviceInterface';
function SetupDiGetDeviceInterfaceDetailA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInterfaceDetailA';
function SetupDiGetInterfaceDeviceDetailA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInterfaceDetailA';
function SetupDiGetDeviceInterfaceDetailW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInterfaceDetailW';
function SetupDiGetInterfaceDeviceDetailW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInterfaceDetailW';
function SetupDiGetDeviceInterfaceDetail; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInterfaceDetail' + NameSuffix;
function SetupDiGetInterfaceDeviceDetail; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInterfaceDetail' + NameSuffix;
function SetupDiInstallDeviceInterfaces; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallDeviceInterfaces';
function SetupDiInstallInterfaceDevices; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallDeviceInterfaces';
{$IFDEF WINXP_UP}
function SetupDiSetDeviceInterfaceDefault; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDeviceInterfaceDefault';
{$ENDIF WINXP_UP}
function SetupDiRegisterDeviceInfo; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiRegisterDeviceInfo';
function SetupDiBuildDriverInfoList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiBuildDriverInfoList';
function SetupDiCancelDriverInfoSearch; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCancelDriverInfoSearch';
function SetupDiEnumDriverInfoA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiEnumDriverInfoA';
function SetupDiEnumDriverInfoW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiEnumDriverInfoW';
function SetupDiEnumDriverInfo; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiEnumDriverInfo' + NameSuffix;
function SetupDiGetSelectedDriverA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetSelectedDriverA';
function SetupDiGetSelectedDriverW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetSelectedDriverW';
function SetupDiGetSelectedDriver; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetSelectedDriver' + NameSuffix;
function SetupDiSetSelectedDriverA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetSelectedDriverA';
function SetupDiSetSelectedDriverW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetSelectedDriverW';
function SetupDiSetSelectedDriver; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetSelectedDriver' + NameSuffix;
function SetupDiGetDriverInfoDetailA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDriverInfoDetailA';
function SetupDiGetDriverInfoDetailW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDriverInfoDetailW';
function SetupDiGetDriverInfoDetail; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDriverInfoDetail' + NameSuffix;
function SetupDiDestroyDriverInfoList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDestroyDriverInfoList';
function SetupDiGetClassDevsA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDevsA';
function SetupDiGetClassDevsW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDevsW';
function SetupDiGetClassDevs; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDevs' + NameSuffix;
function SetupDiGetClassDevsExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDevsExA';
function SetupDiGetClassDevsExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDevsExW';
function SetupDiGetClassDevsEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDevsEx' + NameSuffix;
function SetupDiGetINFClassA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetINFClassA';
function SetupDiGetINFClassW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetINFClassW';
function SetupDiGetINFClass; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetINFClass' + NameSuffix;
function SetupDiBuildClassInfoList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiBuildClassInfoList';
function SetupDiBuildClassInfoListExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiBuildClassInfoListExA';
function SetupDiBuildClassInfoListExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiBuildClassInfoListExW';
function SetupDiBuildClassInfoListEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiBuildClassInfoListEx' + NameSuffix;
function SetupDiGetClassDescriptionA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDescriptionA';
function SetupDiGetClassDescriptionW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDescriptionW';
function SetupDiGetClassDescription; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDescription' + NameSuffix;
function SetupDiGetClassDescriptionExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDescriptionExA';
function SetupDiGetClassDescriptionExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDescriptionExW';
function SetupDiGetClassDescriptionEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDescriptionEx' + NameSuffix;
function SetupDiCallClassInstaller; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCallClassInstaller';
function SetupDiSelectDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSelectDevice';
function SetupDiSelectBestCompatDrv; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSelectBestCompatDrv';
function SetupDiInstallDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallDevice';
function SetupDiInstallDriverFiles; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallDriverFiles';
function SetupDiRegisterCoDeviceInstallers; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiRegisterCoDeviceInstallers';
function SetupDiRemoveDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiRemoveDevice';
function SetupDiUnremoveDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiUnremoveDevice';
function SetupDiMoveDuplicateDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiMoveDuplicateDevice';
function SetupDiChangeState; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiChangeState';
function SetupDiInstallClassA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallClassA';
function SetupDiInstallClassW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallClassW';
function SetupDiInstallClass; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallClass' + NameSuffix;
function SetupDiInstallClassExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallClassExA';
function SetupDiInstallClassExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallClassExW';
function SetupDiInstallClassEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiInstallClassEx' + NameSuffix;
function SetupDiOpenClassRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenClassRegKey';
function SetupDiOpenClassRegKeyExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenClassRegKeyExA';
function SetupDiOpenClassRegKeyExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenClassRegKeyExW';
function SetupDiOpenClassRegKeyEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenClassRegKeyEx' + NameSuffix;
function SetupDiCreateDeviceInterfaceRegKeyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceRegKeyA';
function SetupDiCreateInterfaceDeviceRegKeyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceRegKeyA';
function SetupDiCreateDeviceInterfaceRegKeyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceRegKeyW';
function SetupDiCreateInterfaceDeviceRegKeyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceRegKeyW';
function SetupDiCreateDeviceInterfaceRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceRegKey' + NameSuffix;
function SetupDiCreateInterfaceDeviceRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDeviceInterfaceRegKey' + NameSuffix;
function SetupDiOpenDeviceInterfaceRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInterfaceRegKey';
function SetupDiOpenInterfaceDeviceRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDeviceInterfaceRegKey';
function SetupDiDeleteDeviceInterfaceRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDeleteDeviceInterfaceRegKey';
function SetupDiDeleteInterfaceDeviceRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDeleteDeviceInterfaceRegKey';
function SetupDiCreateDevRegKeyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDevRegKeyA';
function SetupDiCreateDevRegKeyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDevRegKeyW';
function SetupDiCreateDevRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiCreateDevRegKey' + NameSuffix;
function SetupDiOpenDevRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiOpenDevRegKey';
function SetupDiDeleteDevRegKey; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDeleteDevRegKey';
function SetupDiGetHwProfileList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileList';
function SetupDiGetHwProfileListExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileListExA';
function SetupDiGetHwProfileListExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileListExW';
function SetupDiGetHwProfileListEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileListEx' + NameSuffix;
function SetupDiGetDeviceRegistryPropertyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceRegistryPropertyA';
function SetupDiGetDeviceRegistryPropertyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceRegistryPropertyW';
function SetupDiGetDeviceRegistryProperty; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceRegistryProperty' + NameSuffix;
{$IFDEF WINXP_UP}
function SetupDiGetClassRegistryPropertyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassRegistryPropertyA';
function SetupDiGetClassRegistryPropertyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassRegistryPropertyW';
function SetupDiGetClassRegistryProperty; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassRegistryProperty' + NameSuffix;
{$ENDIF WINXP_UP}
function SetupDiSetDeviceRegistryPropertyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDeviceRegistryPropertyA';
function SetupDiSetDeviceRegistryPropertyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDeviceRegistryPropertyW';
function SetupDiSetDeviceRegistryProperty; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDeviceRegistryProperty' + NameSuffix;
{$IFDEF WINXP_UP}
function SetupDiSetClassRegistryPropertyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetClassRegistryPropertyA';
function SetupDiSetClassRegistryPropertyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetClassRegistryPropertyW';
function SetupDiSetClassRegistryProperty; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetClassRegistryProperty' + NameSuffix;
{$ENDIF WINXP_UP}
function SetupDiGetDeviceInstallParamsA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInstallParamsA';
function SetupDiGetDeviceInstallParamsW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInstallParamsW';
function SetupDiGetDeviceInstallParams; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDeviceInstallParams' + NameSuffix;
function SetupDiGetClassInstallParamsA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassInstallParamsA';
function SetupDiGetClassInstallParamsW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassInstallParamsW';
function SetupDiGetClassInstallParams; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassInstallParams' + NameSuffix;
function SetupDiSetDeviceInstallParamsA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDeviceInstallParamsA';
function SetupDiSetDeviceInstallParamsW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDeviceInstallParamsW';
function SetupDiSetDeviceInstallParams; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDeviceInstallParams' + NameSuffix;
function SetupDiSetClassInstallParamsA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetClassInstallParamsA';
function SetupDiSetClassInstallParamsW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetClassInstallParamsW';
function SetupDiSetClassInstallParams; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetClassInstallParams' + NameSuffix;
function SetupDiGetDriverInstallParamsA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDriverInstallParamsA';
function SetupDiGetDriverInstallParamsW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDriverInstallParamsW';
function SetupDiGetDriverInstallParams; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetDriverInstallParams' + NameSuffix;
function SetupDiSetDriverInstallParamsA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDriverInstallParamsA';
function SetupDiSetDriverInstallParamsW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDriverInstallParamsW';
function SetupDiSetDriverInstallParams; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetDriverInstallParams' + NameSuffix;
function SetupDiLoadClassIcon; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiLoadClassIcon';
function SetupDiDrawMiniIcon; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDrawMiniIcon';
function SetupDiGetClassBitmapIndex; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassBitmapIndex';
function SetupDiGetClassImageList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassImageList';
function SetupDiGetClassImageListExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassImageListExA';
function SetupDiGetClassImageListExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassImageListExW';
function SetupDiGetClassImageListEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassImageListEx' + NameSuffix;
function SetupDiGetClassImageIndex; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassImageIndex';
function SetupDiDestroyClassImageList; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiDestroyClassImageList';
function SetupDiGetClassDevPropertySheetsA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDevPropertySheetsA';
function SetupDiGetClassDevPropertySheetsW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDevPropertySheetsW';
function SetupDiGetClassDevPropertySheets; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetClassDevPropertySheets' + NameSuffix;
function SetupDiAskForOEMDisk; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiAskForOEMDisk';
function SetupDiSelectOEMDrv; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSelectOEMDrv';
function SetupDiClassNameFromGuidA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassNameFromGuidA';
function SetupDiClassNameFromGuidW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassNameFromGuidW';
function SetupDiClassNameFromGuid; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassNameFromGuid' + NameSuffix;
function SetupDiClassNameFromGuidExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassNameFromGuidExA';
function SetupDiClassNameFromGuidExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassNameFromGuidExW';
function SetupDiClassNameFromGuidEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassNameFromGuidEx' + NameSuffix;
function SetupDiClassGuidsFromNameA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassGuidsFromNameA';
function SetupDiClassGuidsFromNameW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassGuidsFromNameW';
function SetupDiClassGuidsFromName; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassGuidsFromName' + NameSuffix;
function SetupDiClassGuidsFromNameExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassGuidsFromNameExA';
function SetupDiClassGuidsFromNameExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassGuidsFromNameExW';
function SetupDiClassGuidsFromNameEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiClassGuidsFromNameEx' + NameSuffix;
function SetupDiGetHwProfileFriendlyNameA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileFriendlyNameA';
function SetupDiGetHwProfileFriendlyNameW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileFriendlyNameW';
function SetupDiGetHwProfileFriendlyName; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileFriendlyName' + NameSuffix;
function SetupDiGetHwProfileFriendlyNameExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileFriendlyNameExA';
function SetupDiGetHwProfileFriendlyNameExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileFriendlyNameExW';
function SetupDiGetHwProfileFriendlyNameEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetHwProfileFriendlyNameEx' + NameSuffix;
function SetupDiGetWizardPage; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetWizardPage';
function SetupDiGetSelectedDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetSelectedDevice';
function SetupDiSetSelectedDevice; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiSetSelectedDevice';
function SetupDiGetActualSectionToInstallA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetActualSectionToInstallA';
function SetupDiGetActualSectionToInstallW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetActualSectionToInstallW';
function SetupDiGetActualSectionToInstall; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetActualSectionToInstall' + NameSuffix;
{$IFDEF WINXP_UP}
function SetupDiGetActualSectionToInstallExA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetActualSectionToInstallExA';
function SetupDiGetActualSectionToInstallExW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetActualSectionToInstallExW';
function SetupDiGetActualSectionToInstallEx; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetActualSectionToInstallEx' + NameSuffix;
function SetupEnumInfSectionsA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupEnumInfSectionsA';
function SetupEnumInfSectionsW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupEnumInfSectionsW';
function SetupEnumInfSections; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupEnumInfSections' + NameSuffix;
function SetupVerifyInfFileA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupVerifyInfFileA';
function SetupVerifyInfFileW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupVerifyInfFileW';
function SetupVerifyInfFile; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupVerifyInfFile' + NameSuffix;
function SetupDiGetCustomDevicePropertyA; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetCustomDevicePropertyA';
function SetupDiGetCustomDevicePropertyW; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetCustomDevicePropertyW';
function SetupDiGetCustomDeviceProperty; external SetupApiModuleName {$IFDEF DELAYED_LOADING}delayed{$ENDIF} name 'SetupDiGetCustomDeviceProperty' + NameSuffix;
{$ENDIF WINXP_UP}
